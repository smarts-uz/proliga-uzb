...
import sty from "./PlasmicAvatarPlayer.module.css"; // plasmic-import: 3fwpAay-2jFk/css
  ...
  return (
    ...
    >
      {(() => {
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__axqph)}
          displayHeight={"auto"}
      ...
      >
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__d8Cvi)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__lZVb)}
          displayHeight={"10px"}
          displayMaxHeight={"none"}
          displayMaxWidth={"100%"}
          displayMinHeight={"0"}
